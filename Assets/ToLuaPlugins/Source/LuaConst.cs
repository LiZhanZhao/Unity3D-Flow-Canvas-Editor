...
{
    public static string luaDir = Application.dataPath + "/ToLuaPlugins/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/ToLuaPlugins/ToLua/Lua";        //tolua lua文件目录
